function veda_fn_cdb72b912577427b8cda48f3ceeff23e () {
        
  if (window.veda_fn_cdb72b912577427b8cda48f3ceeff23eCleanup === undefined) {
    window.veda_fn_cdb72b912577427b8cda48f3ceeff23eCleanup = {
      listeners: [],
      push(listener) {
  ...
  window.veda_fn_cdb72b912577427b8cda48f3ceeff23eCleanup.cleanup();

        try {
          const uniqueIds = ["id_462e25c5-f9de-4803-abe1-1e3b95dec763","id_98fdb315-10b6-470c-a6ec-678b0f82d412"];
...
veda_fn_cdb72b912577427b8cda48f3ceeff23e();
function veda_fn_290740372c7a49a99549aacac2db44c4 () {
      
  if (window.veda_fn_290740372c7a49a99549aacac2db44c4Cleanup === undefined) {
    window.veda_fn_290740372c7a49a99549aacac2db44c4Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_290740372c7a49a99549aacac2db44c4Cleanup.cleanup();

      try {
        const uniqueId = "id_67a34143-4be7-47fb-ad01-e92b2d2e34a0";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
countdownEls.forEach((countdownEl) => {
  ...
  window.veda_fn_290740372c7a49a99549aacac2db44c4Cleanup.push(() => {
    destroy();
  });
});
...
veda_fn_290740372c7a49a99549aacac2db44c4();
function veda_fn_10320ba7a1134875b40a072d64db2159 () {
      
  if (window.veda_fn_10320ba7a1134875b40a072d64db2159Cleanup === undefined) {
    window.veda_fn_10320ba7a1134875b40a072d64db2159Cleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_10320ba7a1134875b40a072d64db2159Cleanup.cleanup();

      try {
        const uniqueId = "id_512e87a9-2d30-4a60-aff5-96fe2edad96f";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    window.veda_fn_10320ba7a1134875b40a072d64db2159Cleanup.push(() => {
...
function handleWishList() {
  ...
  listCard.forEach((card) => {
    ...
    window.veda_fn_10320ba7a1134875b40a072d64db2159Cleanup.push(() => btnWishListEl.removeEventListener("click", handleClick));
  });
...
veda_fn_10320ba7a1134875b40a072d64db2159();