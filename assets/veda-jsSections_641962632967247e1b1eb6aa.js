function veda_fn_883ce4c6a2e44338beffa0edf27db06b () {
      
  if (window.veda_fn_883ce4c6a2e44338beffa0edf27db06bCleanup === undefined) {
    window.veda_fn_883ce4c6a2e44338beffa0edf27db06bCleanup = {
      listeners: [],
      push(listener) {
  ...
  window.veda_fn_883ce4c6a2e44338beffa0edf27db06bCleanup.cleanup();

      try {
        const uniqueId = "id_656c18f4-9581-45b6-9bf9-6478a149d480";
...
veda_fn_883ce4c6a2e44338beffa0edf27db06b();
function veda_fn_d5c93c5c61654df68a3453683e5332ff () {
      
  if (window.veda_fn_d5c93c5c61654df68a3453683e5332ffCleanup === undefined) {
    window.veda_fn_d5c93c5c61654df68a3453683e5332ffCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_d5c93c5c61654df68a3453683e5332ffCleanup.cleanup();

      try {
        const uniqueId = "id_ac3bf2d4-ae28-48d6-81ec-8b86f129d7b2";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    window.veda_fn_d5c93c5c61654df68a3453683e5332ffCleanup.push(() => {
...
veda_fn_d5c93c5c61654df68a3453683e5332ff();
function veda_fn_1c48399927fb4f148b2e22fc8d2c490f () {
      
  if (window.veda_fn_1c48399927fb4f148b2e22fc8d2c490fCleanup === undefined) {
    window.veda_fn_1c48399927fb4f148b2e22fc8d2c490fCleanup = {
      listeners: [],
      push(listener) {
        this.listeners.push(listener);
      },
  ...
  window.veda_fn_1c48399927fb4f148b2e22fc8d2c490fCleanup.cleanup();

      try {
        const uniqueId = "id_30781d6f-d1f6-489d-b2fc-694324417316";
        const containers = document.querySelectorAll(`[data-id="${uniqueId}"]`);
        containers.forEach(container => {
          if (!container) {
            return;
...
function handleCompare() {
  ...
  listCard.forEach((card) => {
    ...
    btnCompareEl.addEventListener("click", handleClick);
    window.veda_fn_1c48399927fb4f148b2e22fc8d2c490fCleanup.push(() => {
      btnCompareEl.removeEventListener("click", handleClick);
    });
  });
  let unsubscribeCompare = productCompare.subscribe((state) => {
...
function handleWishList() {
  ...
  listCard.forEach((card) => {
    ...
    btnWishListEl.addEventListener("click", handleClick);
    window.veda_fn_1c48399927fb4f148b2e22fc8d2c490fCleanup.push(() => btnWishListEl.removeEventListener("click", handleClick));
  });
  let unsubscribeWishList = productWishList.subscribe((state) => {
    const listCard = container.querySelectorAll(".product-card-js");
    listCard.forEach((card) => {
...
veda_fn_1c48399927fb4f148b2e22fc8d2c490f();